...
export function ServicesHero() {
  return (
    <section className="relative h-[70vh] w-full bg-black flex flex-col items-center justify-center overflow-hidden">     
      <div className="relative z-20 flex flex-col items-center gap-4 px-4 mt-30 text-center">
        ...
        <p className="text-neutral-400 max-w-xl">
          Let&apos;s build something incredible together. Reach out any time.
        </p>
      </div>
